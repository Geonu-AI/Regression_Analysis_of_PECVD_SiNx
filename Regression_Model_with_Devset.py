...
x1 = (database[1:35,2]-460.27)/180.3 # RF POWER
x2 = (database[1:35,3]-900)/48.9 # Pressure
x3 = (database[1:35,4]-98.7)/23.7 # SiH4 sccm
x4 = (database[1:35,5]-66.2)/9.5 # NH3 sccm
